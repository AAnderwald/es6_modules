...
class WishList {                                                    //create class WishList
    ...
    {                           
        ...
        this.updatedDOMWishList();                                  //update the DOM every time a car is removed from the wishlist
        ...
        {
            document.querySelector(".removeBtn").disable = true;      //if no vehicle in the wish list dont' allow the button to be pushed
        }
    }
    ...
    {                                                                 //users able to view the cars in the WishList from the document, account for this functionality of displaying and updating the DOM
        let container = document.querySelector("#wishListContainer"); //where wishistContainer is an id and to call it you will need the # infront when in JS
        ...
        {   
            ...
            {        
                document.querySelector(".removeBtn").disable = false;   
                car.info();
            });
            ul.appendChild(li);
        }); 
